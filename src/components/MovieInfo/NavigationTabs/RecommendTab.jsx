  ...
  if (
    ...
    return (
      <div className="recommend-tab-container">
        <h3 className="text-xl font-bold text-yellow-400 mb-6">Đề Xuất</h3>
  ...
  return (
    <div className="recommend-tab-container">
      ...
      <div className="mt-6 text-center text-gray-400 text-sm">
        Hiển thị {recommendations.results.length} phim đề xuất
        {recommendations.total_results > recommendations.results.length && (
          <span> (có {recommendations.total_results} kết quả)</span>
        )}
      </div>
    </div>
  );
