...
const Login = ({
  ...
  const [_status, setStatus] = useState(null); // null | "success" | "error"
        ...
        <div className="col-span-12 sm:col-span-5 bg-[#131428] p-8 relative">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full bg-white text-gray-800 py-2 rounded-md flex items-center justify-center gap-1 shadow"
            >
