import { fetchSlider, fetchPreview } from "../utils/api";

// Ví dụ lấy dữ liệu slider:
const data = await fetchSlider("movie", "popular", 15);

// Ví dụ lấy dữ liệu preview:
const preview = await fetchPreview("movie", movieId);
