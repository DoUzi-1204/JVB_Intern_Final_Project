                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {actorsOnly.map((person) => (
                    <div
                      ...
                      className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors duration-200 cursor-pointer flex items-center gap-4"
                      onClick={() =>
                        window.open(
                    ...
                    >
                      ...
                      <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-700 flex-shrink-0">
                        {person.profile_path ? (
                          <img
                            src={`${API_CONFIG.IMAGE_BASE_URL}/w185${person.profile_path}`}
                            alt={person.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {person.known_for && person.known_for.length > 0 && (
                          <p className="text-gray-500 text-xs truncate mt-1">
                            Nổi tiếng với: {person.known_for.map(item => item.title || item.name).slice(0, 2).join(", ")}
                          </p>
                        )}
                      </div>
                    </div>
