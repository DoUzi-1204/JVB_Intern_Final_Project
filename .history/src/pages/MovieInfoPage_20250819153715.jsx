...
const MovieInfoPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-800 text-white">
      ...
      <div className="detailcontainer relative -mt-40 xs-mt-52 lg:-mt-56 xl:-mt-72 z-10 ">
        <div className="container mx-auto max-w-full">
          <div className="grid grid-cols-1  lg:grid-cols-3 gap-0">
            ...
            <div className="maindetail lg:col-span-2">
              <div className="bg-gray-900/95 backdrop-blur-sm rounded-3xl py-3 px-3 xs:px-6 lg:p-6 shadow-2xl">
                <ActionButtons
                  movieData={movieData}
                  isMovie={isMovie}
                  movieId={id}
      ...
      <button onClick={() => setShowRating(true)}>Đánh giá</button>
      <Rating
        visible={showRating}
        ...
        currentRating={8.5}
        ratingCount={120}
        history={[0, 2, 5, 10, 20, 30, 25, 15, 8, 3, 2]}
        onSubmit={(data) => {
          // Xử lý gửi đánh giá
          setShowRating(false);
        }}
