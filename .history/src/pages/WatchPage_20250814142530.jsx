...
const WatchPage = () => {
  ...
  const { movieData, seasons, recommendations, loading, error } =
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className={isTheaterMode ? "" : "pt-20"}>
        {/* Watch Player Section */}
        <div className={isTheaterMode ? "" : "container mx-auto px-4 py-6"}>
          <VideoPlayer 
            movieData={movieData} 
            isMovie={isMovie} 
          ...
          />
          {!isTheaterMode && (
            <VideoAction onTheaterModeToggle={handleTheaterModeToggle} />
          )}
        </div>        {/* Watch Container */}
