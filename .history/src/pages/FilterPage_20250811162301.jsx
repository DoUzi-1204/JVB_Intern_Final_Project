      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400">
            Tìm kiếm phim theo thể loại, quốc gia, năm phát hành và nhiều tiêu chí khác
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-400">
                    ...
                    <span className="text-yellow-400 font-medium">
                      {filters.sortBy === "popularity.desc" && "Phổ biến giảm dần"}
                      {filters.sortBy === "popularity.asc" && "Phổ biến tăng dần"}
                      {filters.sortBy === "vote_average.desc" && "Đánh giá cao nhất"}
                      {filters.sortBy === "vote_average.asc" && "Đánh giá thấp nhất"}
