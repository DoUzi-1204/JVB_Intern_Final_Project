  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch main data
        const [dataResponse, creditsResponse, recommendationsResponse] = await Promise.all([
          fetch(`${BASE_URL}/${mediaType}/${id}?api_key=${API_KEY}&language=vi-VN`),
          fetch(`${BASE_URL}/${mediaType}/${id}/credits?api_key=${API_KEY}&language=vi-VN`),
          fetch(`${BASE_URL}/${mediaType}/${id}/recommendations?api_key=${API_KEY}&language=vi-VN`)
        ]);
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div 
        ...
        style={{
          backgroundImage: backdropUrl ? `url(${backdropUrl})` : 'linear-gradient(135deg, #1f2937 0%, #111827 100%)',
        }}
      >
        {/* Overlay */}
