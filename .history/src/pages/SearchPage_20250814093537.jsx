...
const SearchPage = () => {
  ...
  // For display purposes, we'll show current page count since we don't have 
  // separate totals for movies/tv vs people from the API
  const currentPageMoviesCount = mediaItems.length;
  const currentPagePeopleCount = actorsOnly.length;
    ...
    <div className="min-h-screen bg-gray-900 pt-20">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex gap-2 mb-6">
          ...
          >
            Phim/Phim bộ ({currentPageMoviesCount})
          </button>
          <button
          ...
          >
            Diễn viên ({currentPagePeopleCount})
          </button>
        </div>
