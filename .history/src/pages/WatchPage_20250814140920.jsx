...
const WatchPage = () => {
  ...
  const isMovie = (() => {
    if (location.pathname.includes('/watch/movie/') || location.pathname.includes('/movie/') && location.pathname.includes('/watch')) {
      return true;
    }
    if (location.pathname.includes('/watch/tv/') || location.pathname.includes('/tv/') && location.pathname.includes('/watch')) {
      return false;
    }
