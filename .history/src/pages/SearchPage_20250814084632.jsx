    ...
    <div className="min-h-screen bg-gray-900 pt-20">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6 text-left">
          <h1 className="text-2xl font-bold text-white mb-2 text-left flex items-center gap-2">
            <TbListSearch className="w-6 h-6 text-yellow-500" />
