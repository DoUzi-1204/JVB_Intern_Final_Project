...
const SearchPage = () => {
  ...
  const totalMoviesAndTV = searchResults.total ? 
    Math.max(searchResults.movies?.length + searchResults.tv?.length || 0, 
             searchResults.movies?.length + searchResults.tv?.length || 0) : 0;
  
  const totalPeople = searchResults.people?.length || 0;
