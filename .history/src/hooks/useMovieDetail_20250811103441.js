  ...
  useEffect(() => {
    const fetchMovieDetail = async () => {
      ...
      try {
        ...
        // Filter videos to only get "Official Trailer" with type "Trailer"
        ...
        // If no videos found, keep original empty array
        let finalVideosData = filteredVideos;
        ...
        // Only set cast data, filter out crew
        setCredits({
          cast: creditsData.cast || [],
          crew: [], // Remove crew data since we only want actors
        });
        setVideos(finalVideosData);
        setImages(imagesData);
        // Limit recommendations to 12 items
        setRecommendations({
          ...recommendationsData,
