                ...
                {[...displayMovies, ...displayTv].map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      {/* Vietnamese Title (or English if no Vietnamese) */}
                      <h4 className="text-white font-medium text-sm truncate text-left">
                        {item.title_vi}
                      </h4>
                      
                      {/* English Title (only show if different from Vietnamese) */}
                      {item.title_en && item.title_vi !== item.title_en && (
                        <p className="text-gray-400 text-xs truncate mt-1 text-left">
                          {item.title_en}
                        </p>
                      )}
                      
                      {/* If Vietnamese same as English, show English again */}
                      ...
                      {/* Additional Info */}
                      <div className="flex items-center gap-2 mt-1 text-xs text-gray-400 justify-start">
                        {/* TMDB Score */}
                        {item.vote_average > 0 && (
