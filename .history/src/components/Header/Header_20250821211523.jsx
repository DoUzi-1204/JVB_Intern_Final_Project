      ...
      <div className="w-full px-4 flex items-center justify-between gap-4">
        ...
        {!isSearchOpen && (
          <>
            ...
            {/* Nút Phim lẻ gốc, chỉnh sửa để chuyển hướng đúng */}
            {/* Đã xóa nút Phim lẻ cạnh logo, chỉ giữ lại các nút ở menu */}
            <div className="max-w-none md:max-w-none xl:max-w-md">
