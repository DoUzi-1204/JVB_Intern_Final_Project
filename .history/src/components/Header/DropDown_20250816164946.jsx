...
const DropDown = ({
  ...
  <div className="relative" ref={refEl}>
    ...
    {isOpen && (
      <div className="absolute top-full left-0 mt-2 w-[550px] bg-zinc-900/90 border border-gray-700/50 rounded-lg shadow-xl z-50 overflow-hidden backdrop-blur-sm">
        <div className="p-4">
          {loading ? (
