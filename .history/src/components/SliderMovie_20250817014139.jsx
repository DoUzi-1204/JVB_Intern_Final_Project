        ...
        {loading ? (
          ...
          <>
            ...
            <Swiper
              ...
              virtual
              {/* Slider Container với hiệu ứng Frame Clipping */}
              <div className="relative group px-2" style={{overflow: 'hidden', borderLeft: '4px solid #181c2b', borderRight: '4px solid #181c2b'}}>
                {/* Frame trái */}
                <div
                  style={{
                    position: "absolute",
