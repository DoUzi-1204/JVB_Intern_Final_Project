  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      >
        ...
        {/* Vignette bốn phía */}
        {/* Vignette bốn phía (Tailwind) */}
        <div className="absolute inset-0 pointer-events-none z-20">
          {/* Trên */}
          <div className="absolute top-0 left-0 right-0 h-1/5 bg-gradient-to-b from-blue-900/60 to-transparent"></div>
          {/* Dưới */}
          <div className="absolute bottom-0 left-0 right-0 h-1/5 bg-gradient-to-t from-blue-900/60 to-transparent"></div>
          {/* Trái */}
          <div className="absolute top-0 left-0 bottom-0 w-1/5 bg-gradient-to-r from-blue-900/60 to-transparent"></div>
          {/* Phải */}
          <div className="absolute top-0 right-0 bottom-0 w-1/5 bg-gradient-to-l from-blue-900/60 to-transparent"></div>
        </div>
      </div>
