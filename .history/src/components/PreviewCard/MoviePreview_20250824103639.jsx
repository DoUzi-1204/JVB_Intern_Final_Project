...
const MoviePreview = ({
  ...
  return (
    <div className="w-96 h-[26rem] bg-gray-700 rounded-lg overflow-hidden shadow-2xl">
      ...
      <div className="px-4 pt-1 pb-5 bg-gray-700 h-48 flex flex-col justify-between">
        ...
        <div className="flex items-center space-x-2 mb-3">
          ...
          <Link
            to={`/movie/${movieVi?.id}`}
            className="border border-white/50 bg-gray-600/50 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold flex items-center space-x-2 hover:text-yellow-300 transition-colors"
            title="Chi tiết"
          >
