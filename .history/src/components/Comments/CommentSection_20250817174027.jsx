        ...
        <form className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-transparent text-yellow-400 font-semibold px-6 py-2 rounded-lg flex items-center gap-2 hover:text-yellow-300 transition disabled:opacity-50"
            >
              Gửi
              <span className="material-icons text-lg text-yellow-400">send</span>
            </button>
          </div>
        </form>
      </div>
