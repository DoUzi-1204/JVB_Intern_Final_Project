        ...
        <form className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-transparent text-yellow-400 font-semibold px-6 py-2 rounded-lg flex items-center gap-2 hover:text-yellow-300 transition"
            >
              Gửi
              <IoSendSharp className="text-xl text-yellow-400" />
            </button>
          </div>
        </form>
      </div>
