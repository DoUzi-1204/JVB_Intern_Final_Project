      ...
      <div className="relative group px-2 ">
        {loading ? (
          ...
          <>
            ...
            <button
              ref={prevRef}
              className="absolute left-2 top-1/2 -translate-y-1/2 z-20 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 disabled:opacity-30"
              aria-label="Previous"
            >
            ...
            <button
              ref={nextRef}
              className="absolute right-2 top-1/2 -translate-y-1/2 z-20 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 disabled:opacity-30"
              aria-label="Next"
            >
