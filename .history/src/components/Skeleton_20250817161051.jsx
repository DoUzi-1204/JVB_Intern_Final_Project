...
export const TrendingSkeleton = () => (
  <ul className="space-y-4">
    {Array.from({ length: 10 }).map((_, idx) => (
      <li key={idx} className="flex items-center bg-gray-800 rounded-lg px-7 py-5">
        {/* Poster skeleton */}
        <Skeleton variant="rectangle" width="64px" height="96px" className="rounded shadow flex-shrink-0" />
        {/* Thông tin skeleton */}
