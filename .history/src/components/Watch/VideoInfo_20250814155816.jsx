        ...
        <div className="flex-1">
          ...
          <div className="text-left mt-5">
            <Link
              ...
              className="inline-block px-4 py-1 bg-gradient-to-r from-yellow-600 to-yellow-200 text-black rounded-3xl hover:from-yellow-500 hover:to-yellow-300 transition-all duration-300 font-medium text-sm"
            >
              <span>Xem thêm</span>
            </Link>
          </div>
