        ...
        <div className="flex-1">
          ...
          <div className="text-left mt-4">
            <Link
              ...
              className="inline-block px-4 py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black rounded-3xl hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 font-medium text-sm"
            >
