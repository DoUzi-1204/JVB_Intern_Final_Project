...
const VideoPlayer = ({ movieData, type }) => {
  return (
        ...
        <div className="w-full h-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="text-xl text-white mb-2">
              {type === 'movie' ? movieData?.title || movieData?.original_title : movieData?.name || movieData?.original_name}
            </h3>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-white text-sm">
                00:00 / {type === 'movie' ? `${Math.floor((movieData?.runtime || 0) / 60)}:${String((movieData?.runtime || 0) % 60).padStart(2, '0')}` : '45:00'}
              </div>
            </div>
