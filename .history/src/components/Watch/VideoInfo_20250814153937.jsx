        ...
        <div className="flex-1">
          ...
          <div className="text-left mt-4">
            <Link
              ...
              className="inline-block px-4 py-2 bg-gradient-to-r from-yellow-600 to-yellow-200 text-black rounded-3xl hover:yellow-500 transition-all duration-300 font-medium text-sm"
            >
