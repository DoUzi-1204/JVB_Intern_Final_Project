      ...
      <div className="flex space-x-6">
        ...
        <div className="flex-1">
          <div className="space-y-3">
            ...
            <div className="text-left">
              ...
              <h3 className="text-lg text-gray-300 text-left">
                {getTitle("en")}
              </h3>
            </div>
        ...
        <div className="flex-1">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black rounded-lg hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 font-medium text-sm"
          >
