...
const VideoPlayer = ({ videoSrc, title = "Video Player" }) => {
  ...
  console.log('VideoPlayer props:', { videoSrc, title });
  ...
  return (
    <div 
      className="relative bg-black rounded-lg overflow-hidden group min-h-[50vh]"
