...
const VideoInfo = ({ movieData, isMovie }) => {
  ...
  return (
    <div
      className="relative md:rounded-lg p-2 xs:p-3 sm:p-5"
      style={
        backdropUrl
          ? {
    ...
    >
      <div className="flex flex-col space-y-1.5 xs:space-y-5 md:flex-row md:space-x-6 md:space-y-0">
        {/* Poster */}
        <div className="flex-shrink-0 flex justify-center md:block">
          <img
            ...
            alt={getTitle()}
            className=" w-[124px] h-44 xs:w-[144px] xs:h-52 sm:w-[174px] sm:h-60  md:w-[104px] md:h-40 object-cover rounded-lg border border-white"
          />
        </div>
