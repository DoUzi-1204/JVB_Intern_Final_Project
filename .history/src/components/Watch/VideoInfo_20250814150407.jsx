import React from "react";  const getGenres = () => {
  ...
  const getCertification = () => {
    ...
    return "NR";
  };port { FaStar, FaCalendarAlt, FaGlobe, FaUsers } from "react-icons/fa";
  ...
  return (
    <div className="bg-gray-900/50 rounded-lg p-6">
      <div className="flex space-x-6">
        ...
        {/* Overview */}
        <div className="flex-1">
          <h4 className="text-yellow-400 font-medium mb-2 text-left">Tóm tắt</h4>
