      ...
      <div className="flex space-x-6">
        ...
        <div className="flex-shrink-0">
          <img
            ...
            alt={getTitle()}
            className="w-26 h-36 object-cover rounded-lg"
          />
        </div>
            ...
            <div className="text-left">
              <div className="flex flex-wrap gap-2">
                {movieData.genres?.map((genre) => (
                  <span
                    key={genre.id}
                    className="bg-white/10 border border-white px-2 py-1 rounded text-xs font-normal text-white"
                  >
                    {genre.name}
                  </span>
                ))}
        ...
        <div className="flex-1">
          ...
          <div className="text-left mt-5">
            <Link
              ...
              className="inline-block px-4 py-2 bg-gradient-to-r from-yellow-600 to-yellow-200 text-black rounded-3xl hover:from-yellow-500 hover:to-yellow-300 transition-all duration-300 font-medium text-sm"
            >
              <span>Xem thêm</span>
            </Link>
          </div>
