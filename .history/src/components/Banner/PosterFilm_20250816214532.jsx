...
const PosterFilm = ({
  ...
  return (
    <div className="flex flex-col space-y-3 absolute bottom-20 right-8 lg:flex-row lg:space-x-3">
        ...
        {movies.map((movie) => (
          ...
          >
            <Image404
              ...
              alt={movie.title}
              className="w-14 h-22 lg:w-16 lg:h-24 object-cover shadow-lg rounded-full lg:rounded-lg"
              type="poster"
            />
          </div>
        ))}
