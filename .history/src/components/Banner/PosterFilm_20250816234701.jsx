...
const PosterFilm = ({
  ...
  return (
    <div className="flex flex-col space-y-3 absolute bottom-4 xsm:bottom-7 xs:bottom-10 sm:bottom-12 sm:right-8 sm:flex-row sm:space-x-3 w-full sm:w-auto items-center justify-center lg:flex-row lg:space-x-3">
