...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      <Link to={`/movie/${currentMovie.id}`} className="absolute inset-0 z-0">
        <img
          src={backdropUrl}
      ...
      {/* Bottom Fade */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black/70 via-black/60 to-transparent z-30 pointer-events-none"></div>
