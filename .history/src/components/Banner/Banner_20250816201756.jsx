...
const Banner = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden h-[280px] xs:h-[360px] sm:h-[440px] md:h-[520px] lg:h-[600px] xl:h-[680px]">
      {/* Background */}
      <img
        src={backdropUrl}
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between h-full gap-6 sm:gap-8">
          <InforFilm
