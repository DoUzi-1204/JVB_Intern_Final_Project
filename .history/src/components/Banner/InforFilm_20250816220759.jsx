...
const InforFilm = ({
  ...
  return (
    <div className="max-w-xl space-y-3 text-left">
      ...
      {/* Overview */}
      <p className="text-white text-sm font-normal leading-relaxed max-w-lg text-left line-clamp-3">
      ...
      <div className="flex items-center space-x-4">
        ...
        >
          <TiMediaPlay className="w-6 h-6" />
                   <p className="text-white text-sm font-normal leading-relaxed max-w-lg text-left line-clamp-3 overflow-hidden">
                     {currentDetails?.overview || currentMovie.overview}
                   </p>
        <Link
