    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          placeholder="Tìm kiếm phim, phim bộ, diễn viên..."
          className="w-full bg-gray-800 text-white text-sm px-4 py-2 pl-10 pr-8 rounded-full border border-gray-700 focus:border-yellow-500 focus:outline-none transition-all duration-200"
        />
