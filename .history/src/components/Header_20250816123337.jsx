      ...
      <div className="w-full px-4 flex items-center justify-between gap-4">
        ...
        <div
          className={`transition-all duration-300 flex-1 ${
            isSearchOpen
              ? "block"
              : "hidden md:block max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-md"
          }`}
        >
        ...
        {/* Buttons mobile */}
        <div className="flex items-center gap-2 md:flex xl:hidden">
          {isSearchOpen ? (
            ...
            // Icon search chỉ hiện từ md tới lg (ẩn ở xl)
            <button
              onClick={() => setIsSearchOpen(true)}
              className="block md:block xl:hidden"
            >
