        ...
        {mode === "rate" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-2 w-full">
              <button
                className="flex-1 bg-yellow-400 text-white font-semibold py-2 rounded-full hover:bg-yellow-500 transition-colors flex items-center justify-center gap-2"
                onClick={() => {}}
              >
                Gửi đánh giá
              ...
              <button
                className="flex-1 bg-red-400 text-white font-semibold py-2 rounded-full hover:bg-red-500 transition-colors"
                onClick={() => {
                  setStar(0);
                  setComment("");
                }}
