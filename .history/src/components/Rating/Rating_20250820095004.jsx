        ...
        {mode === "rate" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-2 w-full">
              {/* Nút gửi */}
              <button
                className="flex-1 bg-gradient-to-r from-yellow-600 to-yellow-300 text-black font-normal py-3 rounded-full hover:brightness-110 transition-all flex items-center justify-center gap-2"
                onClick={() => {}}
              >
                Gửi đánh giá
