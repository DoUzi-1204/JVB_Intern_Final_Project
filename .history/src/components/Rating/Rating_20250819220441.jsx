...
const Rating = ({ title = "Tên phim mẫu", onClose }) => {
  ...
  // Modal overlay
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-9000 bg-opacity-75">
      <div className="relative bg-gray-700 rounded-lg shadow-lg w-full max-w-md px-6 pb-6 pt-11 animate-fadeIn">
