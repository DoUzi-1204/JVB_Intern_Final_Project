  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900 bg-opacity-75">
      <div className="relative bg-gray-700 rounded-lg shadow-lg w-full max-w-[600px] px-6 pb-6 pt-11 animate-fadeIn min-h-[500px]">
        ...
        {/* Nhóm nút chuyển chế độ với đường kẻ dọc */}
        <div className="flex justify-center items-center mb-6">
          <button
            className={`px-4 py-2 rounded-l-full font-semibold transition-colors focus:z-10 ${
              mode === "rate"
          ...
          <button
            className={`px-4 py-2 rounded-r-full font-semibold transition-colors focus:z-10 ${
              mode === "history"
                ? "bg-yellow-400 text-white"
                : "bg-gray-100 text-gray-700 hover:bg-yellow-100"
            }`}
