  ...
  const chartOptions = {
    ...
    scales: {
          x: {
            ...
            ticks: { color: "#fff" }, // màu trắng cho trục Ox
            grid: {
              drawTicks: true, // ✅ bật lại dấu gạch nhỏ
              tickLength: 6, // ✅ độ dài của gạch (px)
              drawBorder: true,
              color: "transparent", // ẩn lưới ngang
              borderColor: "#fff", // màu trục
              borderWidth: 1,
            },
          },

      y: {
            title: { display: true, text: "Lượt đánh giá" },
            beginAtZero: true,
            ticks: { color: "#fff", display: false }, // màu trắng cho trục Oy, vẫn ẩn số
            grid: {
              drawTicks: false, // ẩn dấu gạch nhỏ
              drawBorder: true, // vẫn giữ đường trục
              color: "transparent", // ẩn hết các đường lưới
              borderColor: "#fff",
      },
    },
  };
