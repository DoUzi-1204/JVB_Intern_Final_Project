...
const chartAreaBg = {
  ...
  beforeDraw: (chart) => {
    ...
    ctx.fillStyle = "#808080"; // màu nền bạn muốn
    ctx.fillRect(
        ...
        {mode === "rate" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-2 w-full">
              {/* Nút gửi */}
              <button
                className="flex-1 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-normal py-2 rounded-full hover:brightness-110 transition-all flex items-center justify-center gap-2"
                onClick={() => {}}
              >
                Gửi đánh giá
                <CgArrowRight className="text-white text-2xl" />
              </button>

              {/* Nút xóa */}
              <button
                className="flex-1 bg-gradient-to-r from-red-400 to-red-600 text-white font-normal py-2 rounded-full hover:brightness-110 transition-all"
                onClick={() => {
                  setStar(0);
                  setComment("");
                }}
