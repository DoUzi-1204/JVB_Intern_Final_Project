  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900 bg-opacity-75">
      <div className="relative bg-gray-700 rounded-lg shadow-lg w-full max-w-[600px] px-6 pb-6 pt-11 animate-fadeIn min-h-[500px]">
        ...
        {/* Nhóm nút chuyển chế độ kiểu toggle giống Trending.jsx */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex border border-yellow-400 rounded-full overflow-hidden bg-gray-100">
            <button
              className={`px-4 py-2 font-semibold transition-colors focus:z-10 text-sm sm:text-base ${
                mode === "rate"
