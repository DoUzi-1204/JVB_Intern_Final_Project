        ...
        {mode === "rate" && (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-2 w-full">
              {/* Nút gửi */}
              <button
                className="flex-1 bg-gradient-to-r from-yellow-600 to-yellow-300 text-black font-normal py-2 rounded-full hover:brightness-110 transition-all flex items-center justify-center gap-2"
                onClick={() => {}}
              >
                Gửi đánh giá
              ...
              {/* Nút xóa */}
              <button
                className="flex-1 bg-gradient-to-r from-red-600 to-red-300 text-white font-normal py-2 rounded-full hover:brightness-110 transition-all"
                onClick={() => {
                  setStar(0);
                  setComment("");
                }}
