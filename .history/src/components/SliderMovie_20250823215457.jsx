...
const SliderMovie = ({
  ...
  // Determine slidesPerView and breakpoints for now_playing vs others
  const isNowPlaying = endpoint === "/movie/now_playing";
  const slidesPerViewDefault = isNowPlaying ? 4 : VISIBLE_COUNT;
  const breakpoints = isNowPlaying
    ? {
    ...
    : {
        ...
        1115: { slidesPerView: 5, spaceBetween: 10 },
  ...
  return (
    <div className="mb-8">
      ...
      {/* Slider Container */}
      <div
        className={`relative group px-2 py-11 ${
          isNowPlaying ? "overflow-visible" : "overflow-x-hidden"
        }`}
      >
        {loading ? (
          ...
          <>
            ...
            <Swiper
              ...
              spaceBetween={isNowPlaying ? 14 : 20} // khoảng cách mặc định
