...
export default function ActorInfo({ actor, loading }) {
  ...
  return (
    <div
      className="w-full lg:max-w-xs p-0 flex flex-col items-center text-center bg-transparent 
                    lg:items-start lg:text-left lg:border-r lg:border-gray-800 "
    >
      <img
        src={
          actor.profile_path
        ...
        alt={actor.name}
        className="w-40 h-52 object-cover rounded-3xl mb-2 border self-center lg:self-start"
      />
      <h2 className="text-2xl font-medium text-white mb-4 text-left w-full self-center lg:self-start">
        {actor.name}
      </h2>
