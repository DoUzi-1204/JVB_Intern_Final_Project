      ...
      <div className="w-full p-6 bg-gray-800 rounded-lg">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 items-start">
          {[...Array(6)].map((_, idx) => (
            <div
              key={idx}
              className="flex flex-col items-start w-full animate-pulse"
            >
              {/* Poster skeleton */}
              <div className="w-full aspect-[2/3] bg-gray-700 rounded-lg shadow-md mb-3" />

              {/* Title skeleton */}
              <div className="h-4 w-5/6 bg-gray-600 rounded mb-2" />
