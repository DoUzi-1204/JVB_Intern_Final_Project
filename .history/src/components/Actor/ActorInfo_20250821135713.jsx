...
export default function ActorInfo({ actor, loading }) {
  if (loading) {
    return (
      <div className="w-full max-w-xs mx-auto p-6 flex flex-col items-center bg-gray-900 rounded-2xl shadow-lg animate-pulse">
  ...
  return (
    <div className="w-full max-w-xs mx-auto p-6 flex flex-col items-center bg-gray-900 rounded-2xl shadow-lg">
      <img
        src={
          actor.profile_path
