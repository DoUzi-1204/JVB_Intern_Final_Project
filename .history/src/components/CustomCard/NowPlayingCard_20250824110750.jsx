  ...
  return (
    ...
    >
      <Link to={`/${mediaType}/${item.id}`}>
        <div className="relative rounded-lg overflow-hidden bg-transparent h-[220px] lg:h-[230px] sm:h-[250px] ">
          {/* Backdrop: occupy top 2/3 */}
          <div className="w-full aspect-[16/5] sm:aspect-[16/6]  relative bg-gray-800">
            {backdropUrl ? (
              <img
                src={backdropUrl}
                alt={titleVi || titleEn}
