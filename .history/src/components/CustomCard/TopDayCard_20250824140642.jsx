  ...
  return (
    <div className="w-full max-w-[260px]">
      <Link to={`/${mediaType}/${item.id}`} className="block">
        <div className="relative rounded-md overflow-hidden transition-transform duration-200 hover:scale-105 bg-gray-800">
          {/* Poster area */}
          <div
          ...
          <div className="flex items-center justify-between px-3 py-3 bg-gray-900">
            {/* Left: rank - large gradient like Trending */}
            <div className="flex-shrink-0 w-14 flex items-center justify-center">
              <span className="text-4xl font-bold select-none bg-gradient-to-tr from-yellow-100 to-yellow-600 text-transparent bg-clip-text">
                {index + 1}
              </span>
            </div>
            ...
            <div className="ml-3 flex-1 min-w-0 text-left">
              <div className="text-white font-semibold text-sm line-clamp-1">{titleVi}</div>
