...
const NowPlayingCard = ({
  ...
  const { previewData, showPreview, handleMouseEnter, handleMouseLeave, getCertification, formatRuntime, formatReleaseYear } =
  ...
  return (
    <div className="block w-[520px] max-w-full" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
