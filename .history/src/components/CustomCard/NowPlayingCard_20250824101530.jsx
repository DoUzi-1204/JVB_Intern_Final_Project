...
const NowPlayingCard = ({
  ...
  // capture card position when hover starts so preview can be portalled correctly
        ...
        <div className="relative rounded-lg overflow-hidden bg-transparent aspect-[16/9]">
          ...
          <div className="w-full h-[34%] bg-gray-900/90 px-3 py-3 flex items-start">
            <div className="relative flex-shrink-0">
              ...
              <div className="-mt-12 w-20 aspect-[2/3] rounded-md border border-gray-500 overflow-hidden bg-gray-700 shadow-md">
                <Image404
                  src={posterUrl}
                  alt={titleVi || titleEn}
