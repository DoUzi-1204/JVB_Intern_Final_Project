...
const NowPlayingCard = ({
  ...
  // Local cache for english titles to avoid repeated small requests (module/window-level)
  const titleCache = useMemo(() => {
    if (typeof window !== "undefined") {
      if (!window.__titleEnCache) window.__titleEnCache = new Map();
      return window.__titleEnCache;
    }
    return new Map();
  }, []);
  ...
  return (
    <div
      className="block w-[520px] max-w-full h-52"
