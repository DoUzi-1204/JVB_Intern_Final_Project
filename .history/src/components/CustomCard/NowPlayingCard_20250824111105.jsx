  ...
  return (
    ...
    >
      <Link to={`/${mediaType}/${item.id}`}>
        <div className="relative rounded-lg overflow-hidden bg-transparent h-[220px]  sm:h-[250px] ">
          {/* Backdrop: occupy top 2/3 */}
          <div className="w-full aspect-[16/4] sm:aspect-[16/5] lg:aspect-[16/5]  relative bg-gray-800">
            {backdropUrl ? (
              <img
                src={backdropUrl}
                alt={titleVi || titleEn}
