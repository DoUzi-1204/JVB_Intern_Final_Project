            ...
            <div className="w-full h-[66%] relative bg-gray-800">
              {backdropUrl ? (
                ...
                const NowPlayingCard = ({
                  ...
                  // English title should come from preview data (en) when available; otherwise fall back
                  const titleEn = previewData?.en?.title || item?.en_title || item?.title || "";

                  // Hover timer to avoid firing preview on quick pointer moves
                  const hoverTimerRef = useRef(null);
                  ...
                  return (
                    ...
                    >
                      <Link to={`/${mediaType}/${item.id}`}>
                        {/* aspect-ratio keeps width & height responsive like ItemCard */}
                        <div className="relative rounded-lg overflow-hidden bg-transparent aspect-[16/9]">
                          <div className="w-full h-[66%] relative bg-gray-800">
                            {backdropUrl ? (
                              <img
