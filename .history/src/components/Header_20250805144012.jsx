      ...
      <div className="w-full px-4 flex items-center justify-between gap-4">
        ...
        <nav className="flex items-center gap-6 flex-shrink-0">
          ...
          <div className="relative" ref={genreDropdownRef}>
            ...
            {/* Genre Dropdown Menu */}
            {showGenreDropdown && (
              <div className="absolute top-full left-0 mt-2 w-[600px] bg-zinc-900/80 border border-gray-700/50 rounded-lg shadow-xl z-50 overflow-hidden backdrop-blur-sm">
                {loading ? (
