...
const Trending = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-center mb-4 bg-gray-700 rounded-3xl overflow-hidden w-full">
        <button
          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="relative flex items-center w-full z-20">
                ...
                <div className="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-tr from-yellow-400 via-yellow-500 to-yellow-600 shadow-lg">
                  <span className="text-3xl font-bold text-white select-none drop-shadow-md">
                    {idx + 1}
                  </span>
                </div>
              </div>
