...
const Header = () => {
  ...
  const Dropdown = ({
    ...
    <div className="relative" ref={refEl}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-[400px] bg-zinc-900/90 border border-gray-700/50 rounded-lg shadow-xl z-50 overflow-hidden backdrop-blur-sm">
          <div className="p-4">
            {loading ? (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <nav className="absolute top-full left-0 w-full bg-zinc-900/95 backdrop-blur-sm shadow-lg z-50 p-4 xl:hidden">
          ...
          {/* Các nút còn lại 6 nút xếp 2 cột */}
