  ...
  return (
    ...
    >
      <div className="w-full px-4 flex items-center justify-between gap-4">
        ...
        {/* Nav desktop  */}
        {!isSearchOpen && (
          <nav className="hidden xl:flex items-center gap-8 flex-shrink-0 ml-auto">
            <Dropdown
              label="Thể Loại"
              items={mergedGenres}
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Hamburger menu - chỉ hiện khi <xl */}
          {!isSearchOpen && (
            <button className="p-2 rounded-lg text-white block xl:hidden">
