...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-zinc-900 shadow-md z-40 flex flex-col gap-1 px-4 py-3 xl:hidden transition-transform duration-300 transform scale-y-100 origin-top">
          <Link
            to="/movies"
