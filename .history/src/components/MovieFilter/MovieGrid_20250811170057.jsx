    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <p className="text-white text-lg">
          Tìm thấy <span className="font-semibold text-yellow-400">{movies.length}</span> phim
          {totalPages > 1 && (
      ...
      <div className="grid grid-cols-7 gap-4">
        ...
        {displayMovies.length < MOVIES_PER_PAGE && Array.from({ length: MOVIES_PER_PAGE - displayMovies.length }).map((_, index) => (
