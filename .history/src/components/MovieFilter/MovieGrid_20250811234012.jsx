    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <p className="text-white text-lg">
          Tìm thấy{" "}
          <span className="font-semibold text-yellow-400">{totalResults}</span>{" "}
          kết quả
          {totalPages > 1 && (
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-4 mt-8">
          ...
          <div className="flex items-center gap-2 text-white">
            <span>Trang</span>
            <form onSubmit={handleInputPageSubmit} className="flex items-center gap-2">
              <input
                type="number"
                min="1"
                max={totalPages}
                ...
                className="w-16 px-2 py-1 bg-gray-800 border border-gray-600 rounded text-center text-white text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
              />
              <span>/</span>
