      ...
      <div className="flex items-center gap-2 text-white bg-gray-900 px-4 py-2 rounded-lg border border-gray-700">
        ...
        >
          <input
            ...
            className="w-16 px-3 py-2 bg-gray-800 border border-gray-600 rounded-md text-center text-white text-sm focus:outline-none focus:ring-0 focus:ring-yellow-400 focus:border-gray-300 focus:bg-gray-500 transition-all duration-200"
          />
          <span>/</span>
