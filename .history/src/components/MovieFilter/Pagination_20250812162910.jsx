      ...
      <div className="flex items-center gap-2 text-white bg-gray-700 px-4 py-2 rounded-3xl border border-gray-700">
        ...
        >
          <input
            ...
            className="w-16 px-3 py-1.5 bg-gray-700 border border-gray-500 rounded-md text-center text-white text-sm focus:outline-none focus:ring-0 focus:ring-yellow-400 focus:border-gray-300 focus:bg-gray-700 transition-all duration-200"
          />
          <span>/</span>
