  ...
  return (
    <div className="bg-gray-900/95 backdrop-blur-sm rounded-lg overflow-hidden">
      ...
      <button
        ...
        className="w-full bg-gray-800/80 px-3 py-3 flex items-center gap-2 border-b border-gray-700 text-base font-semibold transition-colors duration-200"
      >
        <LuFilter
          size={15}
          className={isExpanded ? "text-yellow-400" : "text-white"}
        />
        <span className={isExpanded ? "text-yellow-400" : "text-white"}>
          Bộ lọc
        </span>
      </button>
