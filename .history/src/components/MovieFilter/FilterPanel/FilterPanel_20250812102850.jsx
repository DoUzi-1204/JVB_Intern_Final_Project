...
const FilterPanel = ({
  ...
  return (
    <div className="rounded-lg overflow-hidden border-[0.5px] border-gray-700 bg-gray-900/95 backdrop-blur-sm">
      {/* Header */}
      <button
        onClick={toggleExpanded}
        className="w-full px-3 py-3 flex items-center gap-2 bg-gray-800 text-white text-base font-semibold transition-colors duration-200"
      >
        <LuFilter
          size={15}
