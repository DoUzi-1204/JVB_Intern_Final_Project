    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-md text-xs font-medium transition-colors duration-200 border ${
            !selectedType
        ...
        {contentTypes.map((type) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-colors duration-200 flex items-center gap-1 border ${
