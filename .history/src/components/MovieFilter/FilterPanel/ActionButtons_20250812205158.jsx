  ...
  return (
    <div className="pt-1 px-36">
      <div className="flex gap-3 justify-start">
        ...
        <button
          onClick={onClose}
          className="border border-gray-200 hover:bg-gray-800 text-white hover:text-white font-medium text-sm text-right py-2.5 px-4 rounded-3xl transition-colors duration-200"
        >
          Đóng
        </button>
      </div>
