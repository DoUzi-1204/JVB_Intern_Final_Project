        ...
        <div className="flex flex-wrap gap-2 flex-1 items-center">
          ...
          <div className="relative">
            <input
              ...
              className="w-32 pl-3 <pr-4></pr-4> py-2 bg-gray-800 border border-gray-600 rounded-md text-white text-xs placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-white focus:border-transparent [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            />
            ...
            {selectedYear && (
              <button
                ...
                className="absolute inset-y-0 right-8 pr-3 flex items-center text-gray-400 hover:text-red-400 transition-colors duration-200"
