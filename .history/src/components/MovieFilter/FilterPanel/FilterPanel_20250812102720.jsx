...
const FilterPanel = ({
  ...
  return (
    <div className="rounded-lg overflow-hidden">
      {/* Header với viền mỏng */}
      <button
        onClick={toggleExpanded}
        className="w-full px-3 py-3 flex items-center gap-2 border-[0.5px] border-gray-700 text-white text-base font-semibold transition-colors duration-200 rounded-lg"
      >
        <LuFilter
          size={15}
      ...
      {/* Filter Content */}
      {isExpanded && (
        <div className="p-4 space-y-4 bg-gray-900/95 rounded-lg mt-2">
          {/* Type Filter */}
