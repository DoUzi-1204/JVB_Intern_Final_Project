...
const FilterPanel = ({
  ...
  return (
    <div className="bg-gray-900/95 backdrop-blur-sm rounded-lg overflow-hidden">
      {/* Header */}
      <div className="bg-gray-800/80 px-3 py-3 flex items-center border-b border-gray-700">
        <h2 className="text-white text-base font-semibold flex items-center gap-1">
          <LuFilter className="text-yellow-300" size={15} />
          Bộ lọc
          <button
            onClick={toggleExpanded}
            className="ml-3 text-white hover:text-yellow-400 transition-colors duration-200"
          >
            <CgChevronDownO
              size={20}
