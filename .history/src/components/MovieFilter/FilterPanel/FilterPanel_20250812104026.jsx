    ...
    <div className="rounded-lg overflow-hidden">
      ...
      <div className="flex justify-start">
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2 border border-gray-700 rounded-md text-white text-base font-semibold transition-colors duration-200"
        >
        <LuFilter
          size={15}
      ...
      {/* Filter Content */}
      {isExpanded && (
        <div className="p-4 space-y-4 border border-gray-700 rounded-lg mt-2">
          {/* Type Filter */}
