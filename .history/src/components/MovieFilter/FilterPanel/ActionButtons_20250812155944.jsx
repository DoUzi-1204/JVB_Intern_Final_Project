    ...
    <div className="pt-1 px-36">
      <div className="flex gap-3 justify-start">
        ...
        <button
          ...
          className="bg-gray-700 bg-opacity-90 border border-gray-300 hover:bg-gray-600 text-white font-medium py-2.5 px-4 rounded-3xl transition-colors duration-200"
        >
          Xóa bộ lọc
        </button>
      </div>
