  ...
  return (
    <div className="pt-1 px-36">
      <div className="flex gap-3 justify-start">
        ...
        <button
          onClick={onClose}
          className="border border-red-500 hover:bg-red-600 text-red-500 hover:text-white font-medium text-sm py-2.5 px-4 rounded-3xl transition-colors duration-200"
        >
          Đóng
        </button>
      </div>
