...
const ActionButtons = ({ filters, onClearFilters, onClose }) => {
  // filters là object { genre, type, country, year, ... }

  const handleApplyFilters = () => {
    const query = new URLSearchParams(filters).toString();
    // reload trang với URL query
    window.location.href = `/duyet-tim?${query}`;
  };
