...
const FilterPanel = ({
  ...
  return (
    <div className="rounded-lg overflow-hidden border border-gray-300 border-[0.1px]">
      {/* Header */}
      <button
        onClick={toggleExpanded}
        className="w-full px-3 py-3 flex items-center gap-2 border-b border-gray-700 text-white text-base font-semibold transition-colors duration-200"
      >
        <LuFilter
          size={15}
