  ...
  return (
    <div className="bg-gray-900/95 backdrop-blur-sm rounded-lg overflow-hidden">
      ...
      <button
        ...
        className="w-full bg-gray-800/80 px-3 py-3 flex items-center gap-2 border-b border-gray-700 text-white text-base font-semibold hover:text-yellow-400 transition-colors duration-200"
      >
        <LuFilter size={15} />
        Bộ lọc
      </button>
