    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(rgba(255,255,255,0.04) 0.25px, transparent 1px)`,
      ...
      `,
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black via-black/60 to-transparent z-[3]"></div>
      </div>
