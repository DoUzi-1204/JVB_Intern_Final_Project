  ...
  return (
    <div className="recommend-tab-container">
      ...
      {!hasRecommendations ? (
        ...
        <>
          <div className="recommendations-grid grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-4 xl:grid-cols-5 gap-y-5 gap-x-2 xs:gap-x-3 xl:gap-x-5">
