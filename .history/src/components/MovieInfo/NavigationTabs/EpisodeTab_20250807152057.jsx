...
const EpisodeTab = ({ movieData, seasons, isMovie, movieId }) => {
  ...
  useEffect(() => {
    if (currentSeasonNumber && currentSeasonNumber !== 1) {
      ...
      {currentSeason && (
        <div className="season-info mt-6 p-4 bg-gray-800 rounded-lg">
          ...
          <div className="mt-2 text-gray-400 text-xs">
            ...
            {currentSeason.season_number === currentSeasonNumber && (
              <span className="text-yellow-400 ml-2">
                • Tập hiện tại: {currentEpisodeNumber}/{currentSeason.episode_count}
              </span>
            )}
          </div>
        </div>
