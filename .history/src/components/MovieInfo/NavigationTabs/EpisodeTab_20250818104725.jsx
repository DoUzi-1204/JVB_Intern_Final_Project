...
const EpisodeTab = ({ movieData, seasons, isMovie, movieId }) => {
      ...
      <div className="episode-tab-container">
        ...
        <div className="episodes-grid grid grid-cols-6 gap-4">
          <Link
            ...
            className="group w-32 bg-gray-800 hover:bg-gray-700 rounded-md  px-2 lg:px-4 py-3 text-center transition-all duration-300 hover:scale-105 border border-gray-700 hover:border-yellow-400"
          >
            <div className="flex items-center justify-center gap-1">
              <TiMediaPlay className="text-white text-base md:text-xl group-hover:text-yellow-400 transition-colors duration-300" />
  ...
  return (
    <div className="episode-tab-container">
      ...
      {/* Episodes Grid */}
      <div className="episodes-grid grid grid-cols-3 xs:grid-cols-4 md:grid-cols-6 gap-4">
        {episodes.map((episode) => (
          <Link
            key={episode.episode_number}
            to={`/watch/tv/${movieId}/${selectedSeason}/${episode.episode_number}`}
            className="group  bg-gray-800 hover:bg-gray-700 rounded-md px-4 py-2 text-center transition-all duration-300 hover:scale-105 border border-gray-700 hover:border-yellow-400"
          >
            <div className="flex items-center justify-center gap-1">
