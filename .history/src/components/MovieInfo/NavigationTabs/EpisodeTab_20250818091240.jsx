      ...
      <div className="episode-tab-container">
        ...
        <div className="episodes-grid grid grid-cols-6 gap-4">
          <Link
            ...
            className="group bg-gray-800 hover:bg-gray-700 rounded-md px-5 py-3 text-center transition-all duration-300 hover:scale-105 border border-gray-700 hover:border-yellow-400"
          >
