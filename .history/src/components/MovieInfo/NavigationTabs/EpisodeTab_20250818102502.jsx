      ...
      <div className="episodes-grid grid grid-cols-6 gap-4">
        {episodes.map((episode) => (
          <Link
            ...
            className="group w-32 bg-gray-800 hover:bg-gray-700 rounded-md px-4 py-3 text-center transition-all duration-300 hover:scale-105 border border-gray-700 hover:border-yellow-400"
          >
            <div className="flex items-center justify-center gap-1">
