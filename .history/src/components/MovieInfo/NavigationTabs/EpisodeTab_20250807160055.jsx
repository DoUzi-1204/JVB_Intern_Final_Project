      ...
      <div className="season-selector mb-6 flex justify-start">
        <div className="relative inline-block">
          <select
            ...
            className="appearance-none bg-yellow-600 hover:bg-yellow-700 text-black font-semibold px-6 py-3 pr-10 rounded-lg focus:outline-none transition-colors cursor-pointer"
          >
            {seasons.map((season) => (
