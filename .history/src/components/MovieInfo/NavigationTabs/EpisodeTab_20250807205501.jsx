      ...
      <div className="season-selector mb-6 flex justify-start">
        <div className="relative inline-block" ref={dropdownRef}>
          <button
            ...
            className="bg-transparent text-white font-semibold px-4 py-2 pr-8 rounded-lg focus:outline-none transition-colors cursor-pointer text-sm flex items-center gap-2 hover:text-glow"
          >
