      ...
      <div className="space-y-3 text-sm text-left">
        ...
        {runtime && (
          <div className="flex items-start gap-2">
            <h4 className="text-yellow-400 font-semibold flex-shrink-0">Thời lượng:</h4>
            <p className="text-gray-300 break-words">{formatRuntime(runtime)}</p>
          </div>
        )}
        ...
        {movieData?.origin_country && movieData.origin_country.length > 0 && (
          <div className="flex items-start gap-2">
            <h4 className="text-yellow-400 font-semibold flex-shrink-0">Quốc gia:</h4>
        ...
        {movieData?.production_companies &&
          movieData.production_companies.length > 0 && (
            <div className="flex items-start gap-2">
              <h4 className="text-yellow-400 font-semibold flex-shrink-0">Sản xuất:</h4>
              <p className="text-gray-300 break-words">
                {movieData.production_companies
        ...
        {getDirector() && (
          <div className="flex items-start gap-2">
            <h4 className="text-yellow-400 font-semibold flex-shrink-0">Đạo diễn:</h4>
            <p className="text-gray-300 break-words">{getDirector()}</p>
          </div>
        )}
      </div>
    </div>
