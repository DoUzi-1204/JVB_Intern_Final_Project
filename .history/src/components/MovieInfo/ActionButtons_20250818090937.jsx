...
const ActionButtons = ({ isMovie, movieId }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-3 xl:gap-4 w-full">
      ...
      <Link
        ...
        text-black px-5 py-3 rounded-full font-semibold 
      ...
      {/* Nhóm nút chức năng */}
      <div className="flex flex-row flex-wrap md:flex-row items-center justify-center gap-3 w-full md:w-auto">
        <button
