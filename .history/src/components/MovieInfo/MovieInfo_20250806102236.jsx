  ...
  return (
    <div className="bg-gray-900/95 backdrop-blur-sm rounded-lg p-6 text-white shadow-2xl">
      ...
      <div className="mb-5 text-left">
        <h1 className="text-2xl font-bold mb-1 leading-tight text-white">
          {displayTitleVi}
        </h1>
      ...
      <div className="mb-3 text-left">
        <div className="flex flex-wrap items-center gap-2 mb-3">
          ...
          {/* Season & Episode for TV Shows - Chuyển lên cùng dòng */}
          {!isMovie && movieData?.last_episode_to_air && (
            <>
              <span className="bg-white/10 border border-white px-2 py-1 rounded text-xs font-normal">
                Phần {movieData.last_episode_to_air.season_number}
              </span>
              <span className="bg-blue-500/20 border border-white text-blue-300 px-2 py-1 rounded text-xs font-normal">
      ...
      <div className="space-y-3 text-sm text-left">
        ...
        {runtime && (
          <div className="flex items-start gap-2">
            <h4 className="text-yellow-400 font-semibold flex-shrink-0">
              Thời lượng:
            </h4>
