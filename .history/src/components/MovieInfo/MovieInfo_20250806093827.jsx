      ...
      <div className="space-y-3 text-sm text-left">
        ...
        {runtime && (
          <div className="flex items-center gap-2">
            <h4 className="text-yellow-400 font-semibold">Thời lượng:</h4>
        ...
        {movieData?.origin_country && movieData.origin_country.length > 0 && (
          <div className="flex items-center gap-2">
            <h4 className="text-yellow-400 font-semibold">Quốc gia:</h4>
        ...
        {getDirector() && (
          <div className="flex items-center gap-2">
            <h4 className="text-yellow-400 font-semibold">Đạo diễn:</h4>
