  ...
  return (
    <div className="flex items-center gap-10">
      ...
      <button
        ...
        className="flex flex-col items-center text-white bg-gray-800 px-4 py-3 rounded-lg transition-colors duration-300 hover:bg-gray-600 hover:text-yellow-400"
      >
