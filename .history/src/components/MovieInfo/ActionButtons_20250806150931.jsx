  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 transition-all duration-300"
        title="Đánh giá phim"
      >
        <FaStar className="w-4 h-4 text-white" />
        <span className="text-white text-sm font-medium">Đánh giá</span>
      </button>
    </div>
  );
};
