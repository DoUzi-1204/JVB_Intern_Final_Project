  ...
  return (
    <div className="flex items-center gap-10">
      ...
      <Link
        ...
        className="bg-gradient-to-r from-yellow-200 to-yellow-500 backdrop-blur-sm text-black px-6 py-3 rounded-full font-semibold hover:from-yellow-400 hover:to-yellow-500 transition-colors flex items-center space-x-2"
      >
        <TiMediaPlay className="w-6 h-6" />
        <span className="text-xl">Xem phim</span>
      </Link>
