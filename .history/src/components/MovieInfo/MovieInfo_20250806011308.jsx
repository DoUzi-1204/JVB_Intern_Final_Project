    ...
    <div className="bg-gray-900/95 backdrop-blur-sm rounded-lg p-6 text-white shadow-2xl">
      ...
      <div className="mb-6 space-y-3">
        <div className="flex flex-wrap items-center gap-3 text-sm">
          ...
          {/* Certification */}
          {getCertification() && (
            <div className="border border-gray-400 px-2 py-1 rounded text-gray-300 font-medium text-xs">
              {getCertification()}
            </div>
          )}
        ...
        {/* Season & Episode for TV Shows or Runtime for Movies */}
        <div className="flex flex-wrap items-center gap-3 text-sm text-gray-300">
          {!isMovie && movieData?.last_episode_to_air && (
            <>
              <span>Phần {movieData.last_episode_to_air.season_number}</span>
              <span>Tập {movieData.last_episode_to_air.episode_number}</span>
            </>
          )}
