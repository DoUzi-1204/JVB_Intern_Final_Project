  ...
  return (
    <div className="flex items-center gap-10">
      ...
      <button
        ...
        title="Yêu thích"
      >
        <div className="p-2 bg-gray-800/50 rounded-full transition-all duration-300 group-hover:bg-yellow-500">
          <FaHeart className="w-5 h-5 text-white group-hover:text-black" />
        </div>
        <span className="text-white text-xs mt-1 group-hover:text-yellow-400">
          Yêu thích
        </span>
      </button>
      ...
      >
        <div className="p-2 bg-gray-800/50 rounded-full transition-all duration-300 group-hover:bg-yellow-500">
          <FaPlus className="w-5 h-5 text-white group-hover:text-black" />
        </div>
        <span className="text-white text-xs mt-1 group-hover:text-yellow-400">
          Thêm vào danh sách
        </span>
      ...
      >
        <div className="p-2 bg-gray-800/50 rounded-full transition-all duration-300 group-hover:bg-yellow-500">
          <FaShare className="w-5 h-5 text-white group-hover:text-black" />
        </div>
        <span className="text-white text-xs mt-1 group-hover:text-yellow-400">
          Chia sẻ
        </span>
      ...
      >
        <div className="p-2 bg-gray-800/50 rounded-full transition-all duration-300 group-hover:bg-yellow-500">
          <FaComment className="w-5 h-5 text-white group-hover:text-black" />
        </div>
        <span className="text-white text-xs mt-1 group-hover:text-yellow-400">
          Bình luận
        </span>
