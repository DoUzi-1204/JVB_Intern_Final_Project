      ...
      <div className="mb-6 text-left">
        <div className="flex flex-wrap items-center gap-2 mb-3">
          ...
          {movieData?.vote_average > 0 && (
            <span className="bg-gradient-to-r from-blue-600 to-blue-800/80 text-white px-2 py-1 rounded text-xs font-medium backdrop-blur-sm flex items-center gap-1">
              TMDB <FaStar className="w-3 h-3 text-yellow-400" />
