  ...
  return (
    ...
    >
      <div className="w-full px-4 flex items-center justify-between gap-4">
        ...
        {/* Search */}
        <div
          className="flex-1 mx-5 transition-all duration-300 
                max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-md"
        >
        ...
        <button className="xl:hidden p-2 rounded-lg bg-gray-700 text-white">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
