  ...
  return (
    ...
    >
      {layout === "horizontal" ? (
        ...
        <div className="w-full max-w-[200px] cursor-pointer transform transition-transform duration-200 hover:scale-105 group">
          {/* Poster Image - Bọc trong Link */}
          <Link to={`/${mediaType}/${item.id}`}>
            <div className="relative w-full h-72 bg-gray-900 rounded-lg overflow-hidden mb-2">
              <Image404
                src={posterUrl}
                alt={titleVi || titleEn}
                className="w-full h-full object-cover"
